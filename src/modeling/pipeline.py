        ...
        [
            ...
            (
                ...
                MovingAverage(
                    ...
                    ma_start_date=ma365_start_date, #date(2009, 2, 26), # datetime(2022, 4, 7) + timedelta(365)
                ),
            ...
            (
                ...
                MovingAverage(
                    ...
                    training_data_start_date=training_data_start_date, #date(2008, 2, 27),
                    training_data_end_date=training_data_end_date, #date(2023, 5, 3),
                    ma_start_date=ma30_start_date, #date(2008, 3, 28), # datetime(2022, 4, 7) + timedelta(30)
                ),
                ["game_date", "batter", "launch_speed", "p_throws", ],
            ),
            # (
